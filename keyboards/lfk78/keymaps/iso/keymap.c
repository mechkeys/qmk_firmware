...
const Layer_Info layer_info[] = {
  ...
  {0x00000000, 0xFFFFFFFF, {0x0000, 0x0FFF, 0x0000}}, // base layers (VANILLA, DEFAULT_WKL, DEFAULT_OSX) - green
  ...
  {0xFFFFFFFF, 0xFFFFFFFF, {0x0FFF, 0x0000, 0x0000}}, // unknown layer - REQUIRED - white
};
...
[VANILLA] = ISO_KEYMAP(
   ...
   * |---------|  |------------------------------------------------------------|  |---------|
   * | F3 | F4 |  |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|Return|  | Del|PgDn|
   * |---------|  |--------------------------------------------------------|   |  `---------'
