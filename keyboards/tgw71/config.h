...
/* RevC/D Matrix config */
    ...
    #define MATRIX_COL_PINS {A2, A3, A4, A5, A6, A7, E6, E7,\
                             F0, F1, F2, F3, C0, C1, C2, C3, D7 }
    #define UNUSED_PINS {A0, A1, B0, B1, B2, B3, B4, B4, B5, B6, B7, C4, C5,\
                         C6, C7, D0, D1, E0, E1, E2, E3, E4, D5, F4, F5, F6,\
                         F7, E6, E7, F0, F1, F2, F3, C0, C1, C2, C3}
