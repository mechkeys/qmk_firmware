...
enum keymap_layout {
    ...
    CS_GO,  // 0x04 Function in CapsLock location, gui/alt swapped for OSX
    FUNC,         // 0x08
    SETTINGS,     // 0x10
};
...
[SETTINGS] = KEYMAP(
  ...
  KC_FN0, KC_FN6,KC_FN8, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,            RESET,
  KC_FN10, KC_FN7,KC_FN9, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                 KC_FN0,           RGB_HUI,
  KC_NO, KC_NO, KC_NO,                  KC_NO,                           KC_NO, KC_NO, KC_NO, KC_TR,     RGB_SAD, RGB_HUD, RGB_SAI),
};
